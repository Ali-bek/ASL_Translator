...
def create_training_data ():
    for classe in classes :
        ...
        for img in os.listdir(path):
            ...
            if classe == "space":
                training_data.append ([new_array, 26])
            elif classe == "del":
                training_data.append ([new_array, 27])
            else:
                training_data.append ([new_array, ord(classe)-65])
...
def create_testing_data ():
    for classe in classes :
        ...
        for img in os.listdir(path):
            ...
            if classe == "space":
                testing_data.append ([new_array, 26])
            elif classe == "del":
                testing_data.append ([new_array, 27])
            else:
                testing_data.append ([new_array, ord(classe)-65])
...
model.save("model_cnn_v5_seg.h5")